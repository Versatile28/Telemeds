  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <center>
            <img src="icons/admin-doctor.png" width="100px">
            <br>
            Doctor
            <br><br>
            <table width="90%">
              <tr>
                <td>
                  <center>
                  <a href="admin-doctor-create.php"><img src="icons/admin-create.png" width="60px"></a>
                    <br>
                    <a href="admin-doctor-create.php">Create</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-doctor-edit.php"><img src="icons/admin-edit.png" width="60px"></a>
                    <br>
                    <a href="admin-doctor-edit.php">Edit</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-doctor-delete.php"><img src="icons/admin-delete.png" width="60px"></a>
                    <br>
                    <a href="admin-doctor-delete.php">Delete</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-doctor-display.php"><img src="icons/admin-display.png" width="60px"></a>
                    <br>
                    <a href="admin-doctor-display.php">Display</a>
                  </center>
                </td>
              </tr>
            </table>

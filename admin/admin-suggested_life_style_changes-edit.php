        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Suggested life style changes Edit</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
                  <tr>
					...
					<td><?php echo $text ?></td>
					<td><a href="admin-suggested_life_style_changes-edit-script.php?id=<?php echo $id ?>"><img src="icons/edit.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Prescribed medicines Edit</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
                  <tr>
					...
					<td><a href="admin-Prescribed_medicines-edit-script.php?id=<?php echo $id ?>"><img src="icons/edit.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

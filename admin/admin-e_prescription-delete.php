        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Eprescription Delete</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/e_prescription/read.php");
...
while($i<$n){
	...
	$bp=$arry[$i]["bp"];
	$hr=$arry[$i]["hr"];
	$temperature=$arry[$i]["temperature"];
?>
                  <tr>
                    <td><?php echo $bp ?></td>
					<td><?php echo $hr ?></td>
					<td><?php echo $temperature ?></td>
					<td><a href="admin-e_prescription-delete-script.php?id=<?php echo $id ?>"><img src="icons/delete.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

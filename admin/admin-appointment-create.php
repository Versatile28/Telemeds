      ...
      <div class="row">
        <div class="col-md-7" style="margin-left:30px;">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form name="appointment-entry-frm" action="admin-appointment-create-script.php" methord="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputDoctorId" name="doctor_id" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputFees">Fees</label>
                <input type="text" id="inputFees" name="fees" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputEprescriptionId">Eprescription id</label>
                <input type="text" id="inputEprescriptionId" name="eprescription_id" class="form-control">
              </div>

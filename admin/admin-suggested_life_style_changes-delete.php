        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Suggested life style changes Delete</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/suggested_life_style_changes/read.php");
...
?>
                  <tr>
					...
					<td><?php echo $text ?></td>
					<td><a href="admin-suggested_life_style_changes-delete-script.php?id=<?php echo $id ?>"><img src="icons/delete.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

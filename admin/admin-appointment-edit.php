        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Appointment Edit</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/appointment/read.php");
$data = array(
'text' => 'fhgfhgfhgf',
'intent' => 'fhjjhjh'
);
...
while($i<$n){
	$id=$arry[$i]["id"];
	$description=$arry[$i]["description"];
	$date=$arry[$i]["date"];
	$time=$arry[$i]["time"];
	$patient_id=$arry[$i]["patient_id"];
	$doctor_id=$arry[$i]["doctor_id"];
	$fees=$arry[$i]["fees"];
	$eprescription_id=$arry[$i]["eprescription_id"];
	$meeting_link=$arry[$i]["meeting_link"];
?>
                  <tr>
                    ...
                    <td><?php echo $doctor_id ?></td>
					          <td><?php echo $fees ?></td>
                    <td><?php echo $eprescription_id ?></td>
					          <td><?php echo $meeting_link ?></td>
					          <td><a href="admin-appointment-edit-script.php?id=<?php echo $id ?>"><img src="icons/edit.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

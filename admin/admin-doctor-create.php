      ...
      <div class="row">
        <div class="col-md-7" style="margin-left:30px;">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form name="doctor-entry-frm" action="admin-doctor-create-script.php" methord="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputDOB" name="dob" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputQualification">Qualification</label>
                <input type="text" id="inputQualification" name="qualification" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputExperience">Experience</label>
                <input type="text" id="inputExperience" name="experience" class="form-control">
              </div>
              <div class="form-group">

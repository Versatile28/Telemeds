        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Doctor Delete</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/doctor/read.php");
...
while($i<$n){
	...
	$phone=$arry[$i]["phone"];
	$qualification=$arry[$i]["qualification"];
	$experience=$arry[$i]["experience"];
	$speciality=$arry[$i]["speciality"];
	$fees=$arry[$i]["fees"];
?>
                  <tr>
                    <td><?php echo $name ?></td>
					...
					<td><?php echo $fees ?></td>
					<td><a href="admin-doctor-delete-script.php?id=<?php echo $id ?>"><img src="icons/delete.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

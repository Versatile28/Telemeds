        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Prescribed medicines Delete</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/prescribed_medicines/read.php");
...
while($i<$n){
	$id=$arry[$i]["id"];
	$e_prescription_id=$arry[$i]["e_prescription_id"];
	$name=$arry[$i]["name"];
	$dossage=$arry[$i]["dossage"];
?>
                  <tr>
                    <td><?php echo $e_prescription_id ?></td>
					<td><?php echo $name ?></td>
					<td><?php echo $dossage ?></td>
					<td><a href="admin-Prescribed_medicines-delete-script.php?id=<?php echo $id ?>"><img src="icons/delete.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Patients Delete</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://localhost/telemeds/api/patients/read.php");
...
?>
                  <tr>
					...
					<td><a href="admin-patients-delete-script.php?id=<?php echo $id ?>"><img src="icons/delete.png" width="30px"></a></td>
                  </tr>
<?php
$i++;
}

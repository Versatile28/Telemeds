  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <center>
            <img src="icons/admin-appointment.png" width="100px">
            <br>
            Appointment
            <br><br>
            <table width="90%">
              <tr>
                <td>
                  <center>
                  <a href="admin-appointment-create.php"><img src="icons/admin-create_appointment.png" width="60px"></a>
                    <br>
                    <a href="admin-appointment-create.php">Create</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-appointment-edit.php"><img src="icons/admin-edit_appointment.png" width="60px"></a>
                    <br>
                    <a href="admin-appointment-edit.php">Edit</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-appointment-delete.php"><img src="icons/admin-delete_appointment.png" width="60px"></a>
                    <br>
                    <a href="admin-appointment-delete.php">Delete</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-appointment-display.php"><img src="icons/admin-display_appointment.png" width="60px"></a>
                    <br>
                    <a href="admin-appointment-display.php">Display</a>
                  </center>
                </td>
              </tr>
            </table>

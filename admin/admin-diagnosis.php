  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <center>
            <img src="icons/admin-diagnosis.png" width="100px">
            <br>
            Diagnosis
            <br><br>
            <table width="90%">
              <tr>
                <td>
                  <center>
                  <a href="admin-diagnosis-create.php"><img src="icons/admin-create.png" width="60px"></a>
                    <br>
                    <a href="admin-diagnosis-create.php">Create</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-diagnosis-edit.php"><img src="icons/admin-edit.png" width="60px"></a>
                    <br>
                    <a href="admin-diagnosis-edit.php">Edit</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-diagnosis-delete.php"><img src="icons/admin-delete.png" width="60px"></a>
                    <br>
                    <a href="admin-diagnosis-delete.php">Delete</a>
                  </center>
                </td>
                <td>
                  <center>
                  <a href="admin-diagnosis-display.php"><img src="icons/admin-display.png" width="60px"></a>
                    <br>
                    <a href="admin-diagnosis-display.php">Display</a>
                  </center>
                </td>
              </tr>
            </table>

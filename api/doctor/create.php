...
foreach($result as $name => $value) {
	...
	$sql="insert into doctor ( name, address, email, phone, dob, qualification, experience, speciality, fees, password ) values ( '$doc_name' , '$address' , '$email', '$phone', '$dob', '$qualification', '$experience', '$speciality', '$fees','$password' )";	
	//echo $sql;							
try
{	
